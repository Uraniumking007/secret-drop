...
import { AlertCircle, Building2, Check, CreditCard, Package, Shield, Zap } from 'lucide-react'
        ...
        <div className="space-y-8 max-w-6xl mx-auto pb-10">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="flex items-center gap-3 pt-2">
                    <Label htmlFor="billing-period" className={cn("cursor-pointer", !isAnnual && "font-semibold")}>Monthly</Label>
                    <Switch
                        id="billing-period"
                        checked={isAnnual}
                        onCheckedChange={setIsAnnual}
                    />
                    <Label htmlFor="billing-period" className={cn("cursor-pointer", isAnnual && "font-semibold")}>
                        Yearly <Badge variant="secondary" className="ml-1 text-xs text-primary">Save 20%</Badge>
                    </Label>
                </div>
            </div>
                ...
                {PLANS.map((plan) => (
                    ...
                    >
                        ...
                        <Card className={cn(
                            ...
                            plan.popular ? "border-primary shadow-lg ring-1 ring-primary/20" : "hover:border-primary/50 hover:shadow-md"
                        )}>
                            <CardHeader>
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    {plan.current && (
                                        <Badge variant="secondary" className="font-medium">Current</Badge>
                                    )}
                                </div>
                ...
                <Card className="flex flex-col">
                    ...
                    <CardContent className="flex-1 space-y-4">
                        ...
                        <div className="rounded-lg bg-muted/50 p-4 text-sm text-muted-foreground flex gap-2">
                            ...
                            <p>
                                Your payment information is securely handled by Stripe. We do not store your card details on our servers.
                            </p>
                        </div>
                    </CardContent>
