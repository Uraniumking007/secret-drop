...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 pt-20 overflow-hidden bg-background">
      <BackgroundMesh />
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-primary opacity-[0.08] blur-[120px] rounded-full pointer-events-none"></div>
      ...
      <div className="relative z-20 text-center max-w-4xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground mb-6 leading-tight">
            ...
            <span className="relative inline-block">
              <span className="absolute inset-0 bg-gradient-to-r from-primary to-white blur-xl opacity-20"></span>
        ...
        >
          ...
          <span className="text-primary">Secure. Ephemeral. Traceable.</span>
        </motion.p>
