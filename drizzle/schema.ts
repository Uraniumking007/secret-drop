...
export const environment = pgTable("environment", {
	...
	index("env_owner_idx").using("btree", table.ownerId.asc().nullsLast().op("text_ops")),
	foreignKey({
...
export const environmentOrg = pgTable("environment_org", {
	id: text().primaryKey().notNull(),
...
export const environmentTeam = pgTable("environment_team", {
	id: text().primaryKey().notNull(),
	environmentId: text("environment_id").notNull(),
